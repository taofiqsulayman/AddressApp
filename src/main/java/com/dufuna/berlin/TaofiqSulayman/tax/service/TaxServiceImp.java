...
public class TaxServiceImp implements TaxService {
    ...
    public double taxCalculator(int income) {
       ...
       if (income <= TaxEntity.TaxBracket1){
            ...
            System.out.println("Your Tax bracket is $"+ TaxEntity.TaxBracket2 + " and outstanding tax is $" + formatter.format(taxOwedRange2) + ". Your total tax is $" + formatter.format(currentTax));
            return currentTax;
            ...
            System.out.println("Your Tax bracket is $"+ TaxEntity.TaxBracket3 + " and outstanding tax is $" + formatter.format(taxOwedRange3) + ". Your total tax is $" + formatter.format(totalTax));
            return totalTax;
            ...
            System.out.println("Your Tax bracket is $"+ TaxEntity.TaxBracket4 + " and outstanding tax is $" + formatter.format(taxOwedRange4) + ". Your total tax is $" + formatter.format(totalTax));
            return totalTax;
        }
        ...
        System.out.println("Your Tax bracket is $"+ TaxEntity.TaxBracket4 + " and above, your outstanding tax is $" + formatter.format(taxOwedRange5) + ". Your total tax is $" + formatter.format(totalTax));
        return totalTax;
    }
}
